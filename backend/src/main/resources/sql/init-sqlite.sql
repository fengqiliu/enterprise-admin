...
-- 数据字典子菜单权限
INSERT INTO sys_menu (menu_id, parent_id, menu_name, menu_type, path, component, permission, icon, sort_order, status, create_time, update_time, deleted) VALUES (21, 11, '字典查询', 3, NULL, NULL, 'business:dict:query', NULL, 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
INSERT INTO sys_menu (menu_id, parent_id, menu_name, menu_type, path, component, permission, icon, sort_order, status, create_time, update_time, deleted) VALUES (22, 11, '字典新增', 3, NULL, NULL, 'business:dict:add', NULL, 2, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
INSERT INTO sys_menu (menu_id, parent_id, menu_name, menu_type, path, component, permission, icon, sort_order, status, create_time, update_time, deleted) VALUES (23, 11, '字典修改', 3, NULL, NULL, 'business:dict:edit', NULL, 3, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
INSERT INTO sys_menu (menu_id, parent_id, menu_name, menu_type, path, component, permission, icon, sort_order, status, create_time, update_time, deleted) VALUES (24, 11, '字典删除', 3, NULL, NULL, 'business:dict:delete', NULL, 4, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
...
INSERT INTO sys_menu (menu_id, parent_id, menu_name, menu_type, path, component, permission, icon, sort_order, status, create_time, update_time, deleted) VALUES (25, 0, '报表中心', 1, '/report', NULL, NULL, 'Assessment', 4, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
INSERT INTO sys_menu (menu_id, parent_id, menu_name, menu_type, path, component, permission, icon, sort_order, status, create_time, update_time, deleted) VALUES (26, 25, '报表管理', 2, '/report', 'Report', 'report:list', 'Assessment', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
INSERT INTO sys_menu (menu_id, parent_id, menu_name, menu_type, path, component, permission, icon, sort_order, status, create_time, update_time, deleted) VALUES (27, 26, '报表查询', 3, NULL, NULL, 'report:query', NULL, 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
INSERT INTO sys_menu (menu_id, parent_id, menu_name, menu_type, path, component, permission, icon, sort_order, status, create_time, update_time, deleted) VALUES (28, 26, '报表生成', 3, NULL, NULL, 'report:generate', NULL, 2, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
INSERT INTO sys_menu (menu_id, parent_id, menu_name, menu_type, path, component, permission, icon, sort_order, status, create_time, update_time, deleted) VALUES (29, 26, '报表下载', 3, NULL, NULL, 'report:download', NULL, 3, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
INSERT INTO sys_menu (menu_id, parent_id, menu_name, menu_type, path, component, permission, icon, sort_order, status, create_time, update_time, deleted) VALUES (30, 26, '报表删除', 3, NULL, NULL, 'report:delete', NULL, 4, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
